...
export const Hero = (props: { videoSrc: string; title: string, socials: { icon: React.ReactNode, link: string }[] }) => {
    return (
        <div className="relative w-full h-screen overflow-hidden bg-black">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white ">
                <h1 className="text-7xl font-bold m-12 w-1/3 text-center">{props.title}</h1>
                <Button Text="Get Started" />
                <div className="flex m-12">
                    <div className="bg-[rgba(0,0,0,0.5)] backdrop-blur-lg px-10 py-5 m-2 rounded-lg flex flex-col items-center">
                        <Scissors />
                        <h3 className='mt-2'>Haircut</h3>
                    </div>
                </div>
            </div>
